...
class Estimator():
    ...
    def _build_model(self):
        ...
        W_fc3 = weight_variable([100, len(VALID_ACTIONS)])
        b_fc3 = weight_variable([len(VALID_ACTIONS)])
        h_fc3 = tf.matmul(h_fc_concatenated, W_fc3) + b_fc3

        self.predictions = h_fc3
    ...
    def predict(self, sess, s, sentence_vec):
        """
        Predicts action values.
        Args:
          sess: Tensorflow session
          image: State input of shape [batch_size, 400] (20x20 state size)
          sentence: Sentence input of shape [batch_size, 3] 
        Returns:
    ...
    def update(self, sess, s, a, y, sentence_vec):
        ...
        Args:
          ...
          s: State input of shape [batch_size, 100]
